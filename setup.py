...
setup(name='unicore-cms-mariestopes',
      version='0.1.0',
      ...
      url='http://github.com/universalcore/unicore-cms-mariestopes',
      license='BSD',
      ...
      test_suite="unicorecmsmariestopes",
      entry_points="""\
      [paste.app_factory]
      main = unicorecmsmariestopes:main
      """,
      message_extractors={'.': [
          ('**.py', 'python', None),
          ('**.pt', 'chameleon', None),
